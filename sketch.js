...
function setup(){
    ...
    box1= new Box(660,306,50,60);
    box2= new Box(715,306,50,60);
    box3= new Box(770,306,50,60);
    box4= new Box(825,306,50,60);
    box5= new Box(880,306,50,60);

    box6= new Box(680,244,50,60);
    box7= new Box(735,244,50,60);
    box8= new Box(790,244,50,60);
    box9= new Box(845,244,50,60);

    box10= new Box(700,182,50,60);
    box11= new Box(755,182,50,60);
    box12= new Box(810,182,50,60);

    box13= new Box(720,120,50,60);
    box14= new Box(775,120,50,60);

    box15= new Box(745,58,50,60);
